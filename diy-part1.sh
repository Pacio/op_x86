...
sed -i 's/CONFIG_CPU_FREQ_GOV_SCHEDUTIL/CONFIG_CPU_FREQ_GOV_CONSERVATIVE/g' target/linux/x86/64/config-5.15
sed -i 's/CONFIG_CPU_FREQ_DEFAULT_GOV_SCHEDUTIL/CONFIG_CPU_FREQ_DEFAULT_GOV_CONSERVATIVE/g' target/linux/x86/64/config-6.1
sed -i 's/CONFIG_CPU_FREQ_GOV_SCHEDUTIL/CONFIG_CPU_FREQ_GOV_CONSERVATIVE/g' target/linux/x86/64/config-6.1
